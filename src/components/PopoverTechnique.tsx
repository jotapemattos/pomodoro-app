  ...
  return (
    <div className='flex items-center justify-center w-1/5 text-white font-mainfont text-sm gap-4'>
          <Popover.Root>
              ...
              <Popover.Portal>
                  <Popover.Content avoidCollisions={true} side='top' sideOffset={20} className='bg-white/80 p-2 flex flex-col w-infoWidth rounded-xl gap-4'>
                    <Popover.Close>
                        <X size={24}/>
                      </Popover.Close>
                        <div className='font-mainfont font-bold flex flex-col gap-6'>
                            <div>
                                ...
                                <h4 className='font-extrabold text-sm text-center'>A method for staying focused and mentally fresh</h4>
                            </div>
