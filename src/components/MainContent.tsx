...
const MainContent = () => {
  ...
  return (
    <div className="h-full w-full min-w-screen flex items-center justify-center">
        <div className="bg-gradient-to-br from-zinc-800 to-white/5 backdrop-opacity-80 backdrop-blur-sm shadow-xl w-4/5 h-main lg:w-2/3 lg:h-4/5 xl:w-1/3 xl:h-main rounded-xl p-4 mt-20 flex flex-col gap-6 items-center justify-between">
